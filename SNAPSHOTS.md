...
The 7810 is worse than iteration8 **for snapshots**: `win7810` (10.0.0.79) is
`DESKTOP-PHE94QD`, confirmed Windows 10 22H2, and it has no `rsync` at all (it is
...
(corrected 2026-08-09). It is reachable over **ssh as user `joepa`**, so SMB never
